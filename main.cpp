...
int main() {
	...
	Livre livre2("L'armee des fourmis mangeusent domme ", auteur1, "Français", "Documentaire", date2, "6666666");
	Livre livre3("domme ", auteur2, "Français", "Documentaire", date2, "6666666");
	Livre livre4("L'armee ", auteur2, "Français", "Documentaire", date2, "6666666");
